# Futures 동시성
# 비동기 작업 실행
# 지연시간(Block) CPU 및 리소스 낭비 방지 -> 파일, 네트워크 I/O 관련 작업 -> 동시성 활용 권장
...
# GIL 우회방법 : 멀티프로세싱 사용, CPython 사용

import os
import time
from concurrent import futures

WORK_LIST = [10000, 100000, 10000000, 100000000]
...
def main():
    ...
    # 결과 건수
    # ThreadPoolExecutor : 현재 프로세스 안에 스레드를 할당해서 진행
    # ProcessPoolExecutor : 새 프로세스 생성해서 진행
